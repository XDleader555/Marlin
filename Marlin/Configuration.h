...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 162.00
  #define DEFAULT_bedKi  17.00
  #define DEFAULT_bedKd 378.00
 ...
 */
#define Z_PROBE_END_SCRIPT "M104 S0"
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT 255  // Y point for Z homing
#endif
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 100, (Y_MAX_POS - 1), 20 }
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { {  -16, 95, 1 } }
  #define NOZZLE_CLEAN_END_POINT   { { -16, 25, 1 } }
