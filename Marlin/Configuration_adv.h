...
#define HOMING_BACKOFF_POST_MM { -X_MIN_POS, -Y_MIN_POS, 10 }  // (mm) Backoff from endstops after homing
...
#define DIGIPOT_MOTOR_CURRENT { DIGIPOT_CURRENT(950),  \
                                DIGIPOT_CURRENT(950),  \
                                DIGIPOT_CURRENT(1075), \
                                DIGIPOT_CURRENT(750),  \
                                DIGIPOT_CURRENT(750)   \
...
//#define LCD_SHOW_E_TOTAL
  ...
  #define EVENT_GCODE_SD_ABORT "G91\nG1 Z5 F3000\nG90\nG1 X0 Y280 F3000"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
